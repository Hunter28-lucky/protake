...
public final class ObservableRangeLong extends AbstractC4262<Long> {

    /* renamed from: ԫ, reason: contains not printable characters */
    public final long f7424;
    ...
    public static final class RangeDisposable extends BasicIntQueueDisposable<Long> {
        ...
        public RangeDisposable(InterfaceC5102<? super Long> interfaceC5102, long j, long j2) {
        ...
        public void run() {
            ...
            for (long j2 = this.index; j2 != j && get() == 0; j2++) {
                interfaceC5102.onNext(Long.valueOf(j2));
            }
            if (get() == 0) {
                lazySet(1);
    ...
    public void subscribeActual(InterfaceC5102<? super Long> interfaceC5102) {
        long j = this.f7424;
        RangeDisposable rangeDisposable = new RangeDisposable(interfaceC5102, j, j + this.f7425);
