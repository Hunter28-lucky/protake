...
public class CountryCodeToRegionCodeMap {
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList47.add("SS");
        map.put(Integer.valueOf(JpegConst.RST3), arrayList47);
        ArrayList arrayList48 = new ArrayList(2);
        arrayList48.add("MA");
        arrayList48.add("EH");
        map.put(Integer.valueOf(JpegConst.RST4), arrayList48);
        ArrayList arrayList49 = new ArrayList(1);
        arrayList49.add("DZ");
        map.put(Integer.valueOf(JpegConst.RST5), arrayList49);
        ArrayList arrayList50 = new ArrayList(1);
        arrayList50.add("TN");
        map.put(Integer.valueOf(JpegConst.SOI), arrayList50);
        ArrayList arrayList51 = new ArrayList(1);
        arrayList51.add("LY");
        map.put(Integer.valueOf(JpegConst.SOS), arrayList51);
        ArrayList arrayList52 = new ArrayList(1);
        arrayList52.add("GM");
        map.put(220, arrayList52);
        ArrayList arrayList53 = new ArrayList(1);
        arrayList53.add("SN");
        map.put(Integer.valueOf(JpegConst.DRI), arrayList53);
        ...
        arrayList57.add("CI");
        map.put(Integer.valueOf(JpegConst.APP1), arrayList57);
        ArrayList arrayList58 = new ArrayList(1);
        arrayList58.add("BF");
        map.put(Integer.valueOf(JpegConst.APP2), arrayList58);
        ArrayList arrayList59 = new ArrayList(1);
        arrayList59.add("NE");
        map.put(Integer.valueOf(JpegConst.APP3), arrayList59);
        ArrayList arrayList60 = new ArrayList(1);
        arrayList60.add("TG");
        map.put(Integer.valueOf(JpegConst.APP4), arrayList60);
        ArrayList arrayList61 = new ArrayList(1);
        arrayList61.add("BJ");
        map.put(Integer.valueOf(JpegConst.APP5), arrayList61);
        ArrayList arrayList62 = new ArrayList(1);
        arrayList62.add("MU");
        map.put(Integer.valueOf(JpegConst.APP6), arrayList62);
        ArrayList arrayList63 = new ArrayList(1);
        arrayList63.add("LR");
        map.put(Integer.valueOf(JpegConst.APP7), arrayList63);
        ArrayList arrayList64 = new ArrayList(1);
        arrayList64.add("SL");
        map.put(Integer.valueOf(JpegConst.APP8), arrayList64);
        ArrayList arrayList65 = new ArrayList(1);
        arrayList65.add("GH");
        map.put(Integer.valueOf(JpegConst.APP9), arrayList65);
        ArrayList arrayList66 = new ArrayList(1);
        arrayList66.add("NG");
        map.put(Integer.valueOf(JpegConst.APPA), arrayList66);
        ArrayList arrayList67 = new ArrayList(1);
        arrayList67.add("TD");
        map.put(Integer.valueOf(JpegConst.APPB), arrayList67);
        ArrayList arrayList68 = new ArrayList(1);
        arrayList68.add("CF");
        map.put(Integer.valueOf(JpegConst.APPC), arrayList68);
        ArrayList arrayList69 = new ArrayList(1);
        arrayList69.add("CM");
        map.put(Integer.valueOf(JpegConst.APPD), arrayList69);
        ArrayList arrayList70 = new ArrayList(1);
        arrayList70.add("CV");
        map.put(Integer.valueOf(JpegConst.APPE), arrayList70);
        ArrayList arrayList71 = new ArrayList(1);
        arrayList71.add("ST");
        map.put(Integer.valueOf(JpegConst.APPF), arrayList71);
        ...
        arrayList76.add("AO");
        map.put(Integer.valueOf(H264Const.PROFILE_HIGH_444), arrayList76);
        ...
        arrayList86.add("KE");
        map.put(Integer.valueOf(JpegConst.COM), arrayList86);
        ...
        arrayList90.add("MZ");
        map.put(Integer.valueOf(TsConstants.kTS_PID_Data), arrayList90);
        ...
        arrayList133.add("CZ");
        map.put(Integer.valueOf(TypedValues.CycleType.TYPE_EASING), arrayList133);
        ArrayList arrayList134 = new ArrayList(1);
        arrayList134.add("SK");
        map.put(Integer.valueOf(TypedValues.CycleType.TYPE_WAVE_SHAPE), arrayList134);
        ArrayList arrayList135 = new ArrayList(1);
        arrayList135.add("LI");
        map.put(Integer.valueOf(TypedValues.CycleType.TYPE_WAVE_PERIOD), arrayList135);
        ArrayList arrayList136 = new ArrayList(1);
        arrayList136.add("FK");
        map.put(500, arrayList136);
        ArrayList arrayList137 = new ArrayList(1);
        arrayList137.add("BZ");
        map.put(Integer.valueOf(TypedValues.PositionType.TYPE_TRANSITION_EASING), arrayList137);
        ArrayList arrayList138 = new ArrayList(1);
        arrayList138.add("GT");
        map.put(Integer.valueOf(TypedValues.PositionType.TYPE_DRAWPATH), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("SV");
        map.put(Integer.valueOf(TypedValues.PositionType.TYPE_PERCENT_WIDTH), arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("HN");
        map.put(Integer.valueOf(TypedValues.PositionType.TYPE_PERCENT_HEIGHT), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        map.put(Integer.valueOf(TypedValues.PositionType.TYPE_SIZE_PERCENT), arrayList141);
        ...
        arrayList143.add("PA");
        map.put(Integer.valueOf(TypedValues.PositionType.TYPE_PERCENT_Y), arrayList143);
        ...
        arrayList192.add("MV");
        map.put(Integer.valueOf(SyntaxConstants.WINDOW_SMALL_LEN_LONG), arrayList192);
