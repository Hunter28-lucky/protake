    ...
    public static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        private void scheduleRetry(Uri uri, long j) {
            synchronized (this.mLock) {
                ...
                if (this.mMainHandlerLoadCallback == null) {
                    this.mMainHandlerLoadCallback = new Runnable() { // from class: androidx.emoji2.text.Ԭ
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f87.loadInternal();
                        }
                    };
                }
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                ...
                this.mExecutor.execute(new Runnable() { // from class: androidx.emoji2.text.Ԫ
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f86.createMetadata();
                    }
                });
            }
        }
