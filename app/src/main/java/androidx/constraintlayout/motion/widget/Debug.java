...
public class Debug {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (int i2 = 0; i2 < fields.length; i2++) {
                ...
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(FinderManager.MACHINE_NOT_VALID)) {
                        System.out.println(str2 + "       " + field.getName() + MyUTIL.white_space + obj);
                    }
    ...
    public static void dumpPoc(Object obj) throws IllegalAccessException, SecurityException, IllegalArgumentException {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(FinderManager.MACHINE_NOT_VALID)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals(BuildConfig.VERSION_NAME)) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
                    System.out.println(str + "    " + field.getName() + MyUTIL.white_space + obj2);
                }
            } catch (IllegalAccessException unused) {
            }
        }
    ...
    public static void logStack(String str, String str2, int i) {
        ...
        String str3 = MyUTIL.white_space;
    ...
    public static void printStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= iMin; i2++) {
            StackTraceElement stackTraceElement = stackTrace[i2];
            String str3 = ".(" + stackTrace[i2].getFileName() + Constants.COLON_SEPARATOR + stackTrace[i2].getLineNumber() + ") ";
    ...
    public static String getState(MotionLayout motionLayout, int i, int i2) throws Resources.NotFoundException {
        ...
        return resourceEntryName.replaceAll(CharBuffer.allocate((resourceEntryName.length() - i2) / length).toString().replace((char) 0, JwtParser.SEPARATOR_CHAR) + "_", "_");
    }
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams layoutParams, String str) throws IllegalAccessException, SecurityException, IllegalArgumentException {
        ...
        for (Field field : layoutParams.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(FinderManager.MACHINE_NOT_VALID)) {
                    System.out.println(str2 + "       " + name + MyUTIL.white_space + obj);
                }
            } catch (IllegalAccessException unused) {
            }
        }
