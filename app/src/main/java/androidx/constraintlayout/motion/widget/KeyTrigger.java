    ...
    private void fire(String str, View view) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (method == null) {
            try {
                ...
                Log.e("KeyTrigger", "Could not find method \"" + str + "\"on class " + view.getClass().getSimpleName() + MyUTIL.white_space + Debug.getName(view));
                return;
            }
        }
        try {
            ...
            Log.e("KeyTrigger", "Exception in call \"" + this.mCross + "\"on class " + view.getClass().getSimpleName() + MyUTIL.white_space + Debug.getName(view));
        }
    }
