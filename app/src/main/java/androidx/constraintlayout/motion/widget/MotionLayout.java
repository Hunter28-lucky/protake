...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + MyUTIL.white_space + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                sb2.append(string);
                sb2.append(constraintWidget.mBottom.mTarget != null ? TransmitHelper.CAMERA_UNIT_B_CONTENT : "_");
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + MyUTIL.white_space + constraintWidget + MyUTIL.white_space + string4);
            }
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            String str2 = TransmitHelper.CAMERA_UNIT_B_CONTENT;
            String string4 = "__";
            if (constraintAnchor != null) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(ExifInterface.GPS_DIRECTION_TRUE);
                sb2.append(constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : TransmitHelper.CAMERA_UNIT_B_CONTENT);
                string = sb2.toString();
            } else {
                string = "__";
            }
            ...
            if (constraintWidget.mBottom.mTarget != null) {
                StringBuilder sb4 = new StringBuilder();
                sb4.append(TransmitHelper.CAMERA_UNIT_B_CONTENT);
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            Log.v(TAG, MyUTIL.white_space + Debug.getLocation() + MyUTIL.white_space + Debug.getName(this) + MyUTIL.white_space + Debug.getName(getContext(), this.mCurrentState) + MyUTIL.white_space + Debug.getName(childAt) + childAt.getLeft() + MyUTIL.white_space + childAt.getTop());
        }
    }
