...
public class Transition implements TypedValues {
    ...
    public static Interpolator getInterpolator(int i, final String str) {
        switch (i) {
            case -1:
                return new Interpolator() { // from class: d3
            ...
            case 0:
                return new Interpolator() { // from class: e3
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 1:
                return new Interpolator() { // from class: f3
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 2:
                return new Interpolator() { // from class: g3
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 3:
                return new Interpolator() { // from class: h3
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 4:
                return new Interpolator() { // from class: k3
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 5:
                return new Interpolator() { // from class: j3
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 6:
                return new Interpolator() { // from class: i3
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
