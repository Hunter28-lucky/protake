    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (motionPathsArr2[i9].customAttributes.containsKey(str6) && (customVariable = motionPathsArr2[i9].customAttributes.get(str6)) != null) {
            ...
            while (i19 < size) {
                if (motionPathsArr2[i19].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        ...
                        iArr3[1] = motionPathsArr2[i19].getCustomDataCount(str8);
                        i3 = 0;
                        iArr3[0] = size;
                    ...
                    motionPaths.getCustomData(str8, dArr4[i20], i3);
                    i20++;
                } else {
                    motionPathsArr = motionPathsArr2;
                }
        ...
        if (motionPathsArr3[0].mPathMotionArc != -1) {
            ...
            for (int i21 = 0; i21 < size; i21++) {
                iArr4[i21] = motionPathsArr3[i21].mPathMotionArc;
                dArr5[i21] = r6.time;
