...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ShortcutInfo.Builder intents = new Object(this.mContext, this.mId) { // from class: android.content.pm.ShortcutInfo.Builder
            static {
        ...
        }.setShortLabel(this.mLabel).setIntents(this.mIntents);
