...
public final class TypedArrayKt {
    ...
    public static final CharSequence[] getTextArrayOrThrow(TypedArray typedArray, @StyleableRes int i) {
        ...
        C3921.m12665(textArray, "getTextArray(index)");
        return textArray;
    }
    ...
    public static final <R> R use(TypedArray typedArray, InterfaceC2392<? super TypedArray, ? extends R> interfaceC2392) {
        C3921.m12666(typedArray, "<this>");
        C3921.m12666(interfaceC2392, "block");
        R rInvoke = interfaceC2392.invoke(typedArray);
        typedArray.recycle();
        return rInvoke;
    }
}
