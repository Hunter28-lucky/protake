...
public final class LinkifyCompat {
    ...
    private static final Comparator<LinkSpec> COMPARATOR = new Comparator() { // from class: androidx.core.text.util.Ϳ
        ...
        while (true) {
            try {
                ...
                if (strFindAddress != null && (iIndexOf = string.indexOf(strFindAddress)) >= 0) {
                    ...
                    try {
                        linkSpec.url = "geo:0,0?q=" + URLEncoder.encode(strFindAddress, Platform.UTF_8);
                        arrayList.add(linkSpec);
