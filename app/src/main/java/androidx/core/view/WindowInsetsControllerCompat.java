...
public final class WindowInsetsControllerCompat {
    ...
    public static class Impl20 extends Impl {
        ...
        private void showForType(int i) {
            ...
            viewFindViewById.post(new Runnable() { // from class: androidx.core.view.Ϳ
    ...
    public static class Impl30 extends Impl {
        ...
        public void addOnControllableInsetsChangedListener(@NonNull final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListener2 = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.Ԩ
                public final void onControllableInsetsChanged(WindowInsetsController windowInsetsController, int i) {
                    this.f80.lambda$addOnControllableInsetsChangedListener$0(onControllableInsetsChangedListener, windowInsetsController, i);
                }
            };
