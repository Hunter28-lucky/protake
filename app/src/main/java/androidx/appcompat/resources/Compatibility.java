...
public final class Compatibility {
    ...
    public static class Api15Impl {
        ...
        @DoNotInline
        public static void getValueForDensity(@NonNull Resources resources, int i, int i2, @NonNull TypedValue typedValue, boolean z) throws Resources.NotFoundException {
