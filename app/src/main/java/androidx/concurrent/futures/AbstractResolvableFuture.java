...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public static final class SafeAtomicHelper extends AtomicHelper {
        ...
        public boolean casListeners(AbstractResolvableFuture<?> abstractResolvableFuture, Listener listener, Listener listener2) {
            return C3777.m12082(this.listenersUpdater, abstractResolvableFuture, listener, listener2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        public boolean casValue(AbstractResolvableFuture<?> abstractResolvableFuture, Object obj, Object obj2) {
            return C3777.m12082(this.valueUpdater, abstractResolvableFuture, obj, obj2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        public boolean casWaiters(AbstractResolvableFuture<?> abstractResolvableFuture, Waiter waiter, Waiter waiter2) {
            return C3777.m12082(this.waitersUpdater, abstractResolvableFuture, waiter, waiter2);
        }
    ...
    public final V get(long j, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        String str = "Waited " + j + MyUTIL.white_space + timeUnit.toString().toLowerCase(locale);
        if (nanos + 1000 < 0) {
            ...
            if (jConvert > 0) {
                String str3 = str2 + jConvert + MyUTIL.white_space + lowerCase;
                if (z) {
                    str3 = str3 + Constants.ACCEPT_TIME_SEPARATOR_SP;
                }
                str2 = str3 + MyUTIL.white_space;
            }
            if (z) {
