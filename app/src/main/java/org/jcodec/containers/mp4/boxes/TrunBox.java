...
public class TrunBox extends FullBox {
    ...
    public static Factory copy(TrunBox trunBox) {
        TrunBox trunBoxCreateTrunBox2 = createTrunBox2(trunBox.sampleCount, trunBox.dataOffset, trunBox.firstSampleFlags, trunBox.sampleDuration, trunBox.sampleSize, trunBox.sampleFlags, trunBox.sampleCompositionOffset);
        trunBoxCreateTrunBox2.setFlags(trunBox.getFlags());
        trunBoxCreateTrunBox2.setVersion(trunBox.getVersion());
        return new Factory(trunBoxCreateTrunBox2);
    }
