...
public class TrackFragmentHeaderBox extends FullBox {
    ...
    public static class Factory {
        ...
        public Factory baseDataOffset(long j) {
            ...
            trackFragmentHeaderBox.baseDataOffset = (int) j;
            return this;
        }
    ...
    public static Factory copy(TrackFragmentHeaderBox trackFragmentHeaderBox) {
        TrackFragmentHeaderBox trackFragmentHeaderBoxTfhd = tfhd(trackFragmentHeaderBox.trackId, trackFragmentHeaderBox.baseDataOffset, trackFragmentHeaderBox.sampleDescriptionIndex, trackFragmentHeaderBox.defaultSampleDuration, trackFragmentHeaderBox.defaultSampleSize, trackFragmentHeaderBox.defaultSampleFlags);
        trackFragmentHeaderBoxTfhd.setFlags(trackFragmentHeaderBox.getFlags());
        trackFragmentHeaderBoxTfhd.setVersion(trackFragmentHeaderBox.getVersion());
        return new Factory(trackFragmentHeaderBoxTfhd);
    }
