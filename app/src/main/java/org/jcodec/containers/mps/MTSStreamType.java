...
public final class MTSStreamType {
    ...
    private MTSStreamType(int i, boolean z, boolean z2) {
        this.tag = i;
        this.video = z;
        this.audio = z2;
        _values.add(this);
    ...
    public static MTSStreamType fromTag(int i) {
        for (MTSStreamType mTSStreamType : values()) {
            if (mTSStreamType.tag == i) {
                return mTSStreamType;
            }
        }
        return null;
    }
