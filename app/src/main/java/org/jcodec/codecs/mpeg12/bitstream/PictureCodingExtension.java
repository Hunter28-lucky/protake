...
public class PictureCodingExtension implements MPEGHeader {
    ...
    public int[][] f_code = (int[][]) Array.newInstance((Class<?>) Integer.TYPE, 2, 2);
    ...
    public void write(ByteBuffer byteBuffer) {
        ...
        bitWriter.write1Bit(this.compositeDisplay != null ? 1 : 0);
        CompositeDisplay compositeDisplay = this.compositeDisplay;
        if (compositeDisplay != null) {
            compositeDisplay.write(bitWriter);
        }
        bitWriter.flush();
    }
}
