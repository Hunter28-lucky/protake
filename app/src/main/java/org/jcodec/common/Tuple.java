...
public class Tuple {
    ...
    public static <T0> List<T0> _1_project0(List<_1<T0>> list) {
        ...
        Iterator<_1<T0>> it = list.iterator();
        while (it.hasNext()) {
    ...
    public static <T0, U> List<_1<U>> _1map0(List<_1<T0>> list, Mapper<T0, U> mapper) {
        ...
        Iterator<_1<T0>> it = list.iterator();
        while (it.hasNext()) {
            linkedList.add(single(mapper.map(it.next().v0)));
        }
        return linkedList;
    }
    ...
    public static <T0, T1> List<T0> _2_project0(List<_2<T0, T1>> list) {
        LinkedList linkedList = new LinkedList();
        Iterator<_2<T0, T1>> it = list.iterator();
        while (it.hasNext()) {
            linkedList.add(it.next().v0);
        }
        return linkedList;
    ...
    public static <T0, T1, T2, T3> List<T0> _3_project0(List<_3<T0, T1, T2>> list) {
        LinkedList linkedList = new LinkedList();
        Iterator<_3<T0, T1, T2>> it = list.iterator();
        while (it.hasNext()) {
            linkedList.add(it.next().v0);
        }
        return linkedList;
    ...
    public static <T0, T1, T2, T3> List<T0> _4_project0(List<_4<T0, T1, T2, T3>> list) {
        LinkedList linkedList = new LinkedList();
        Iterator<_4<T0, T1, T2, T3>> it = list.iterator();
        while (it.hasNext()) {
            linkedList.add(it.next().v0);
        }
        return linkedList;
