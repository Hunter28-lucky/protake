...
public final class Label {
    ...
    public static final Label Ambisonic_Y = new Label(MlKitException.CODE_SCANNER_CAMERA_PERMISSION_NOT_GRANTED);
    public static final Label Ambisonic_Z = new Label(MlKitException.CODE_SCANNER_APP_NAME_UNAVAILABLE);
    public static final Label MS_Mid = new Label(MlKitException.CODE_SCANNER_TASK_IN_PROGRESS);
    public static final Label MS_Side = new Label(MlKitException.CODE_SCANNER_PIPELINE_INITIALIZATION_ERROR);
    public static final Label XY_X = new Label(MlKitException.CODE_SCANNER_PIPELINE_INFERENCE_ERROR);
    public static final Label XY_Y = new Label(MlKitException.CODE_SCANNER_GOOGLE_PLAY_SERVICES_VERSION_TOO_OLD);
