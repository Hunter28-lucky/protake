...
public abstract class RestrictedSuspendLambda extends RestrictedContinuationImpl implements InterfaceC5139<Object> {
    private final int arity;

    public RestrictedSuspendLambda(int i, InterfaceC4355<Object> interfaceC4355) {
