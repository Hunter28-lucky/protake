...
public final class ClientComponent_ClientModule_ProvideConnectionQueueExecutorServiceFactory implements InterfaceC3628<ExecutorService> {
    ...
    public static ExecutorService proxyProvideConnectionQueueExecutorService() {
        return (ExecutorService) C4618.m14073(ClientComponent.ClientModule.provideConnectionQueueExecutorService(), "Cannot return null from a non-@Nullable @Provides method");
    }
