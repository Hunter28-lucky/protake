...
public class ImageConvertUtils {
    ...
    @NonNull
    @KeepForSdk
    public static Bitmap yv12ToBitmap(@NonNull ByteBuffer byteBuffer, int i, int i2, int i3) throws MlKitException, IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    private static byte[] zzb(@NonNull byte[] bArr, int i, int i2) throws MlKitException, IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    @NonNull
    @KeepForSdk
    public Bitmap nv21ToBitmap(@NonNull ByteBuffer byteBuffer, int i, int i2, int i3) throws MlKitException, IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
