...
public class MobileVisionBase<DetectionResultT> implements Closeable, LifecycleObserver {
    ...
    public MobileVisionBase(@NonNull MLTask<DetectionResultT, InputImage> mLTask, @NonNull Executor executor) {
        ...
        this.zzf = executor;
        mLTask.pin();
        this.zzg = mLTask.callAfterLoad(executor, new Callable() { // from class: com.google.mlkit.vision.common.internal.zze
    ...
    public final /* synthetic */ Object zza(InputImage inputImage) throws Exception {
        zzji zzjiVarZze = zzji.zze("detectorTaskWithResource#run");
        zzjiVarZze.zzb();
        try {
    ...
    public final /* synthetic */ Object zzb(MlImage mlImage) throws Exception {
        InputImage inputImageZza = CommonConvertUtils.zza(mlImage);
