...
final class zzaj implements ObjectEncoderContext {
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_common.zzai
    ...
    private final zzaj zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    public final zzaj zzd(@NonNull FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        ...
        zzah zzahVarZzj = zzj(fieldDescriptor);
        zzag zzagVar = zzag.DEFAULT;
        int iOrdinal = zzahVarZzj.zzb().ordinal();
        if (iOrdinal == 0) {
            zzn(zzahVarZzj.zza() << 3);
            zzn(i);
        } else if (iOrdinal == 1) {
            zzn(zzahVarZzj.zza() << 3);
            zzn((i + i) ^ (i >> 31));
        } else if (iOrdinal == 2) {
            zzn((zzahVarZzj.zza() << 3) | 5);
