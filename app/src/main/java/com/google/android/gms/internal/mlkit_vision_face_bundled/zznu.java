...
final class zznu {
    ...
    public final void zzC(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzntVar.zzp(i, (iIntValue >> 31) ^ (iIntValue + iIntValue));
                i2++;
            }
            return;
        }
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            iZzD += zznt.zzD((iIntValue2 >> 31) ^ (iIntValue2 + iIntValue2));
        }
        this.zza.zzq(iZzD);
        while (i2 < list.size()) {
            zznt zzntVar2 = this.zza;
            int iIntValue3 = ((Integer) list.get(i2)).intValue();
            zzntVar2.zzq((iIntValue3 >> 31) ^ (iIntValue3 + iIntValue3));
            i2++;
        }
    }
    ...
    public final void zzE(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzntVar.zzr(i, (jLongValue >> 63) ^ (jLongValue + jLongValue));
                i2++;
            }
            return;
        }
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            iZzE += zznt.zzE((jLongValue2 >> 63) ^ (jLongValue2 + jLongValue2));
        }
        this.zza.zzq(iZzE);
        while (i2 < list.size()) {
            zznt zzntVar2 = this.zza;
            long jLongValue3 = ((Long) list.get(i2)).longValue();
            zzntVar2.zzs((jLongValue3 >> 63) ^ (jLongValue3 + jLongValue3));
            i2++;
        }
    }
    ...
    public final void zzJ(int i, List list, boolean z) throws IOException {
        ...
        int iZzD = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzD += zznt.zzD(((Integer) list.get(i3)).intValue());
        }
        this.zza.zzq(iZzD);
        while (i2 < list.size()) {
    ...
    public final void zzL(int i, List list, boolean z) throws IOException {
        ...
        int iZzE = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzE += zznt.zzE(((Long) list.get(i3)).longValue());
        }
        this.zza.zzq(iZzE);
        while (i2 < list.size()) {
    ...
    public final void zzj(int i, List list, boolean z) throws IOException {
        ...
        int iZzx = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzx += zznt.zzx(((Integer) list.get(i3)).intValue());
        }
        this.zza.zzq(iZzx);
        while (i2 < list.size()) {
    ...
    public final void zzv(int i, Object obj, zzqe zzqeVar) throws IOException {
        ...
        int iZzp = zzmtVar.zzp();
        if (iZzp == -1) {
            iZzp = zzqeVar.zza(zzmtVar);
            zzmtVar.zzr(iZzp);
        }
        zznqVar.zzq(iZzp);
