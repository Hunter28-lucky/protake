...
final class zzbl implements ObjectEncoderContext {
    private static final Charset zza = Charset.forName(Platform.UTF_8);
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_common.zzbk
    ...
    private final zzbl zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    public final zzbl zzd(@NonNull FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        ...
        zzbj zzbjVarZzj = zzj(fieldDescriptor);
        zzbi zzbiVar = zzbi.DEFAULT;
        int iOrdinal = zzbjVarZzj.zzb().ordinal();
        if (iOrdinal == 0) {
            zzn(zzbjVarZzj.zza() << 3);
            zzn(i);
        } else if (iOrdinal == 1) {
            zzn(zzbjVarZzj.zza() << 3);
            zzn((i + i) ^ (i >> 31));
        } else if (iOrdinal == 2) {
            zzn((zzbjVarZzj.zza() << 3) | 5);
