...
public final class zznu implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    arrayListCreateTypedList = SafeParcelReader.createTypedList(parcel, header, zznz.CREATOR);
                    break;
                case 11:
                    arrayListCreateTypedList2 = SafeParcelReader.createTypedList(parcel, header, zznp.CREATOR);
                    break;
                default:
        ...
        return new zznt(i, rect, f, f2, f3, f4, f5, f6, f7, arrayListCreateTypedList, arrayListCreateTypedList2);
    }
