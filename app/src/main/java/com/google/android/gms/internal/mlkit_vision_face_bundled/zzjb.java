...
public enum zzjb implements zzcb {
    ...
    AUTOML_IMAGE_LABELING_RUN(MPEGConst.EXTENSION_START_CODE),
    AUTOML_IMAGE_LABELING_CREATE(182),
    AUTOML_IMAGE_LABELING_CLOSE(MPEGConst.SEQUENCE_END_CODE),
    AUTOML_IMAGE_LABELING_LOAD(MPEGConst.GROUP_START_CODE),
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(101),
    ...
    AGGREGATED_ON_DEVICE_SEGMENTATION(JpegConst.RST0),
    AGGREGATED_CUSTOM_OBJECT_INFERENCE(JpegConst.RST1),
    AGGREGATED_CUSTOM_IMAGE_LABEL_DETECTION(JpegConst.RST2),
    REMOTE_CONFIG_FETCH(271),
    REMOTE_CONFIG_ACTIVATE(272),
    REMOTE_CONFIG_LOAD(b.a),
    ...
    ODML_IMAGE(MPSUtils.PACK),
    OPTIONAL_MODULE_BARCODE_DETECTION(MPSUtils.SYSTEM),
