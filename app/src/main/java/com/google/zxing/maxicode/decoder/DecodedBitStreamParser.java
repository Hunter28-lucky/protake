...
final class DecodedBitStreamParser {
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, TsConstants.ACESType_h265, 25, 26, TsConstants.ACESType_h264, 28, 29, 30, 19, 20, 21, 22, 23, 24, cb.k, cb.l, cb.m, cb.n, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2});
    }
    ...
    private static String getPostCode3(byte[] bArr) {
        String[] strArr = SETS;
        return String.valueOf(new char[]{strArr[0].charAt(getInt(bArr, new byte[]{39, 40, 41, ExifInterface.START_CODE, 31, 32})), strArr[0].charAt(getInt(bArr, new byte[]{33, 34, 35, TsConstants.ACESType_h265, 25, 26})), strArr[0].charAt(getInt(bArr, new byte[]{TsConstants.ACESType_h264, 28, 29, 30, 19, 20})), strArr[0].charAt(getInt(bArr, new byte[]{21, 22, 23, 24, cb.k, cb.l})), strArr[0].charAt(getInt(bArr, new byte[]{cb.m, cb.n, 17, 18, 7, 8})), strArr[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
