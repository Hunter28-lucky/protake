...
public final class d extends a {
    ...
    private AtomicInteger f17647e = new AtomicInteger(0);
    private AtomicInteger f = new AtomicInteger(0);

    @Override // com.efs.sdk.base.core.f.a
    public final void a() {
        if ((this.c.get() == 0 && this.d.get() == 0 && this.b.get() == 0 && this.f.get() == 0 && this.f17647e.get() == 0) || this.a == null || !ControllerCenter.getGlobalEnvStruct().isEnableWaStat()) {
            return;
        }
