...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public int getWXAppSupportAPI() throws InterruptedException {
        ...
        b.f17733e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
    ...
    public boolean registerApp(String str, long j) {
        ...
        c1915a.a = "com.tencent.mm";
        c1915a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c1915a.c = "weixin://registerapp?appid=" + this.appId;
        c1915a.d = j;
        return a.a(this.context, c1915a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C1915a c1915a = new a.C1915a();
        c1915a.a = "com.tencent.mm";
        c1915a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c1915a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c1915a);
    }
}
