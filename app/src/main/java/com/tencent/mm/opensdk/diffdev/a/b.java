...
public class b extends AsyncTask<Void, Void, a> {
                    ...
                    try {
                        ...
                        if (string != null && string.length() != 0) {
                            ...
                            if (bArrDecode != null && bArrDecode.length != 0) {
                                ...
                                aVar.f17731e = bArrDecode;
                                aVar.b = jSONObject.getString("uuid");
                                String string2 = jSONObject.getString("appname");
                                aVar.c = string2;
                                Log.d("MicroMsg.SDK.GetQRCodeResult", String.format("parse succ, save in memory, uuid = %s, appname = %s, imgBufLength = %d", aVar.b, string2, Integer.valueOf(aVar.f17731e.length)));
                                return aVar;
                            }
    ...
    public a doInBackground(Void[] voidArr) throws Throwable {
        ...
        String str = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.a, this.c, this.d, this.b, this.f17730e);
        long jCurrentTimeMillis = System.currentTimeMillis();
        byte[] bArrA = com.tencent.mm.opensdk.channel.a.a.a(str, OkHttpUtils.DEFAULT_MILLISECONDS);
    ...
    public void onPostExecute(a aVar) {
        ...
        Log.d("MicroMsg.SDK.GetQRCodeTask", "onPostExecute, get qrcode success imgBufSize = " + aVar2.f17731e.length);
        this.f.onAuthGotQrcode(aVar2.d, aVar2.f17731e);
