// OBSOLETE: Google Play ProxyBillingActivity - No longer used. Safe to delete if not referenced.
    ...
    */
    ...
    public void onCreate(@Nullable Bundle bundle) throws IntentSender.SendIntentException {
        ...
        try {
            ...
            com.google.android.gms.internal.play_billing.zzb.zzl(TAG, "Got exception while trying to start a purchase flow.", e2);
