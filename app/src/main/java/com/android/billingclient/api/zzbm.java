...
final class zzbm extends com.google.android.gms.internal.play_billing.zzk {
    ...
    public /* synthetic */ zzbm(WeakReference weakReference, ResultReceiver resultReceiver, zzbl zzblVar) {
    ...
    public final void zza(Bundle bundle) throws RemoteException {
        ...
        try {
            ...
            com.google.android.gms.internal.play_billing.zzb.zzl("BillingClient", "Runtime error while launching intent for the external offer dialog.", e2);
            ...
            bundle3.putString("INTERNAL_LOG_ERROR_ADDITIONAL_DETAILS", String.format("%s: %s", e2.getClass().getName(), com.google.android.gms.internal.play_billing.zzab.zzb(e2.getMessage())));
