...
public class a {
    ...
    public String b(String str) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(f17792e)) {
                return null;
            }
            UMRTLog.e(UMRTLog.RTLOG_TAG, "--->>> 子进程事件数据解密失败，换老秘钥重试");
            try {
                String str4 = new String(DataHelper.decrypt(Base64.decode(str.getBytes(), 0), f17792e.getBytes()));
                try {
        ...
        try {
            if (TextUtils.isEmpty(a)) {
                ...
                if (!TextUtils.isEmpty(multiProcessSP)) {
                    f17792e = c(multiProcessSP);
                    UMRTLog.e(UMRTLog.RTLOG_TAG, "--->>>> primaryKey: " + f17792e);
                }
