...
public class Response implements av<Response, e>, Serializable, Cloneable {
    ...
    private static final bp MSG_FIELD_DESC = new bp(NotificationCompat.CATEGORY_MESSAGE, (byte) 11, 2);
    ...
    static {
        ...
        enumMap.put((EnumMap) e.MSG, (e) new bh(NotificationCompat.CATEGORY_MESSAGE, (byte) 2, new bi((byte) 11)));
