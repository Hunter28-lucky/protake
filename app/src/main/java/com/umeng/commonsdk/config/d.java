...
public class d {
    ...
    public static final String f17794e = "262139";
    ...
    public static String[] k = new String[EnumC1924d.values().length];
    ...
    static {
        ...
        for (int i5 = 0; i5 < EnumC1924d.values().length; i5++) {
            k[i5] = EnumC1924d.values()[i5].toString();
        }
        Map<String, String[]> map4 = l;
        if (map4 != null) {
            map4.put(EnumC1924d.class.getName(), k);
        }
    }
