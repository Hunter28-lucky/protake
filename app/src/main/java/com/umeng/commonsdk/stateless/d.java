...
public class d {
            ...
            try {
                synchronized (b) {
                    try {
                        ...
                        File file = new File(context.getFilesDir() + "/" + a.f17805e);
                        if (!file.isDirectory()) {
                            file.mkdir();
                        }
    ...
    */
        ...
        try {
            synchronized (b) {
                ...
                if (context != null && context.getApplicationContext() != null) {
                    String str = context.getApplicationContext().getFilesDir() + File.separator + a.f17805e;
                    if (!TextUtils.isEmpty(str)) {
    ...
    public static String a(Context context, boolean z) {
        ...
        try {
            if (z) {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f17805e;
            } else {
