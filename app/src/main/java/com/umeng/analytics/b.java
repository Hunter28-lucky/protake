...
public class b implements n, t {
    ...
    public void c(Context context) {
        ...
        try {
            ...
            if (UMConfigure.AUTO_ACTIVITY_PAGE_COLLECTION != MobclickAgent.PageMode.LEGACY_MANUAL) {
                this.f17749e.b(context.getClass().getName());
            }
            i();
        } catch (Throwable th) {
            if (MLog.DEBUG) {
    ...
    public void b(Context context) {
        ...
        try {
            ...
            if (UMConfigure.AUTO_ACTIVITY_PAGE_COLLECTION != MobclickAgent.PageMode.LEGACY_MANUAL) {
                this.f17749e.a(context.getClass().getName());
            }
            h();
            if (UMConfigure.isDebugLog() && (context instanceof Activity)) {
    ...
    private boolean b(String str, Object obj) {
        ...
        try {
            length = str.getBytes(Platform.UTF_8).length;
        ...
        if (obj instanceof String) {
            if (((String) obj).getBytes(Platform.UTF_8).length <= 256) {
                return true;
            }
            MLog.e("value length is " + ((String) obj).getBytes(Platform.UTF_8).length + ", please check value, illegal");
            return false;
        }
        ...
        try {
            ...
            if (AnalyticsConfig.enable) {
                ...
                if (th != null) {
                    ...
                    jSONObject.put(com.umeng.analytics.pro.d.R, DataHelper.convertExceptionToString(th));
    ...
    public void a(String str, String str2) {
        try {
            ...
            jSONObject.put("ts", jCurrentTimeMillis);
            Context context2 = a;
            UMWorkDispatch.sendEvent(context2, o.a.f17782e, CoreProtocol.getInstance(context2), jSONObject);
            Context context3 = a;
            UMWorkDispatch.sendEvent(context3, o.a.o, CoreProtocol.getInstance(context3), jSONObject);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
