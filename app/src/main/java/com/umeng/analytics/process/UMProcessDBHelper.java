    ...
    private List<a> datasAdapter(String str, JSONArray jSONArray) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                aVar.f17789e = jSONObject.optInt("__t");
                aVar.f = str;
            ...
            try {
                ...
                for (a aVar : list) {
                    try {
                        ...
                        contentValues.put("__t", Integer.valueOf(aVar.f17789e));
                        contentValues.put(a.InterfaceC1923a.f, aVar.f);
                        contentValues.put("__av", aVar.g);
                        contentValues.put("__vc", aVar.h);
                        contentValues.put("__s", aVar.d);
                        sQLiteDatabaseA.insert(a.InterfaceC1923a.a, null, contentValues);
    ...
    */
    private java.util.List<com.umeng.analytics.process.UMProcessDBHelper.a> readEventByProcess(java.lang.String r13) throws java.lang.Throwable {
        ...
        L22:
            ...
            r4.a = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            ...
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            int r5 = r3.getInt(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f17789e = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
        ...
        try {
            ...
            try {
                ...
                if (size > 0) {
                    ...
                    sQLiteDatabaseA.delete(a.InterfaceC1923a.a, null, null);
                }
                sQLiteDatabaseA.setTransactionSuccessful();
                sQLiteDatabaseA.endTransaction();
            } catch (Exception unused) {
    ...
    public void deleteMainProcessEventDatasByIds(List<Integer> list) {
        ...
        try {
            ...
            while (it.hasNext()) {
                sQLiteDatabaseA.delete(a.InterfaceC1923a.a, "id=?", new String[]{String.valueOf(it.next())});
            }
            sQLiteDatabaseA.setTransactionSuccessful();
        } catch (Exception unused) {
            if (sQLiteDatabaseA != null) {
    ...
    public JSONObject readVersionInfoFromColumId(Integer num) throws Throwable {
        ...
        try {
            ...
            try {
                try {
                    sQLiteDatabaseA.beginTransaction();
                    Cursor cursorQuery = sQLiteDatabaseA.query(a.InterfaceC1923a.a, null, "rowid=?", new String[]{String.valueOf(num)}, null, null, null);
                    if (cursorQuery != null) {
                        try {
                            try {
