...
public class i {
    ...
    private static String f17776e = null;
    ...
    private void l() {
        try {
            if (TextUtils.isEmpty(f17776e)) {
                ...
                f17776e += new StringBuilder(f17776e).reverse().toString();
    ...
    public void d() {
        ...
        try {
            ...
            String[] strArr = {"", FinderManager.MACHINE_NOT_VALID};
            for (int i = 0; i < 2; i++) {
    ...
    */
    ...
    public String d(String str) {
        try {
            return TextUtils.isEmpty(f17776e) ? str : new String(DataHelper.decrypt(Base64.decode(str.getBytes(), 0), f17776e.getBytes()));
    ...
    */
    ...
    public String c(String str) {
        try {
            return TextUtils.isEmpty(f17776e) ? str : Base64.encodeToString(DataHelper.encrypt(str.getBytes(), f17776e.getBytes()), 0);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:62:0x00e6 A[EXC_TOP_SPLITTER, PHI: r1 r13
      ...
      0x00e6: PHI (r13v5 java.lang.Object) = (r13v4 java.lang.Object), (r13v7 java.lang.Object) binds: [B:37:0x00d5, B:43:0x00e4] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    ...
    */
    private void a(java.lang.String r18, org.json.JSONObject r19, android.database.sqlite.SQLiteDatabase r20, java.lang.String r21) throws org.json.JSONException {
        /*
            ...
            java.lang.String r2 = "__a"
            r14 = 0
            boolean r3 = r2.equals(r12)     // Catch: java.lang.Throwable -> Le3
            if (r3 == 0) goto L25
            org.json.JSONArray r0 = r0.optJSONArray(r2)     // Catch: java.lang.Throwable -> Le3
            if (r0 == 0) goto L24
        ...
        L24:
            return
        L25:
            boolean r2 = r1.equals(r12)     // Catch: java.lang.Throwable -> Le3
            if (r2 == 0) goto L38
            org.json.JSONArray r0 = r0.optJSONArray(r1)     // Catch: java.lang.Throwable -> Le3
            if (r0 == 0) goto L37
            int r1 = r0.length()     // Catch: java.lang.Throwable -> Le3
            if (r1 > 0) goto L22
        L37:
        ...
        L39:
            r0 = 1
            java.lang.String[] r3 = new java.lang.String[r0]     // Catch: java.lang.Throwable -> Le3
            r16 = 0
            r3[r16] = r12     // Catch: java.lang.Throwable -> Le3
            java.lang.String r1 = "__sd"
            java.lang.String r4 = "__ii=? "
            java.lang.String[] r5 = new java.lang.String[r0]     // Catch: java.lang.Throwable -> Le3
            r5[r16] = r11     // Catch: java.lang.Throwable -> Le3
            r6 = 0
            r7 = 0
            r8 = 0
            r9 = 0
            r0 = r17
            r2 = r20
            android.database.Cursor r0 = r0.a(r1, r2, r3, r4, r5, r6, r7, r8, r9)     // Catch: java.lang.Throwable -> Le3
            if (r0 == 0) goto L6c
        L56:
