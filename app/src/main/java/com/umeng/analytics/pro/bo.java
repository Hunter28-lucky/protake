...
public class bo extends bu {
    ...
    private static final bp f17761e = new bp("", (byte) 0, 0);
    ...
    public static class b {
        ...
        /* renamed from: e, reason: collision with root package name */
        public static final byte f17762e = 5;
    ...
    private long F() throws bb {
        ...
        if (this.g.h() >= 10) {
            ...
            while (true) {
                ...
                if ((bArrF[iG + i2] & BER.ASN_LONG_LEN) != 128) {
                    this.g.a(i2 + 1);
                    return j3;
                }
                i3 += 7;
    ...
    public br n() throws bb {
        ...
        return new br(d((byte) (bU >> 4)), d((byte) (bU & cb.m)), iE);
    }
    ...
    public String z() throws bb {
        ...
        try {
            if (this.g.h() < iE) {
                return new String(e(iE), Platform.UTF_8);
            }
            String str = new String(this.g.f(), this.g.g(), iE, Platform.UTF_8);
            this.g.a(iE);
            return str;
