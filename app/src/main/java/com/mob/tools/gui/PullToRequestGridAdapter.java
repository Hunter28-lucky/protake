...
public abstract class PullToRequestGridAdapter extends PullToRequestBaseListAdapter {
    ...
    public PullToRequestGridAdapter(PullToRequestView pullToRequestView) {
        ...
        ScrollableGridView scrollableGridViewOnNewGridView = onNewGridView(getContext());
        this.gridView = scrollableGridViewOnNewGridView;
        scrollableGridViewOnNewGridView.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: com.mob.tools.gui.PullToRequestGridAdapter.1
            ...
            public void onScroll(AbsListView absListView, int i, int i2, int i3) {
                ...
                pullToRequestGridAdapter.onScroll(pullToRequestGridAdapter.gridView, i, i2, i3);
            }
