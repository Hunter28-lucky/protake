...
public class HashonHelper implements PublicMemberKeeper {
    ...
    private static Object c(Object obj) throws Throwable {
        ...
        if (obj instanceof Enum) {
            ...
            map.put(o.a("004iVdkdc<l"), ((Enum) obj).name());
            return map;
        }
    ...
    public static String fromObject(Object obj) {
        ...
        HashMap map = new HashMap();
        map.put(o.a("004^eddefg.d"), objC);
        return fromHashMap(map).substring(8, r2.length() - 1).trim();
    }
    ...
    public static <T> T fromJson(String str, Class<T> cls) {
        ...
        if (str.startsWith("[")) {
            obj = mapFromJson;
            if (str.endsWith("]")) {
                obj = mapFromJson.get(o.a("008[fhdfdjXiLeddefg)d"));
            }
        }
        try {
    ...
    private static <T> T a(Object obj, Class<T> cls, Type[] typeArr) throws Throwable {
        ...
        if (!cls.isPrimitive() && !Number.class.isAssignableFrom(cls) && !cls.equals(Character.class)) {
            if (a.class.isAssignableFrom(cls)) {
                try {
                    return (T) ReflectHelper.invokeStaticMethod(ReflectHelper.importClass(cls.getName()), o.a("007j[dfeddc:i,flfh"), obj);
            ...
            if (cls.isEnum()) {
                return (T) Enum.valueOf(cls, String.valueOf(((HashMap) obj).get(o.a("004iTdkdcBl"))));
            }
            if (cls.isArray()) {
        ...
        return (T) Boolean.valueOf(o.a("004d;dhdcRi").equals(String.valueOf(obj)));
    }
}
