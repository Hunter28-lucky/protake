...
public interface IAlixPay extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlixPay {
        ...
        /* renamed from: com.alipay.android.app.IAlixPay$Stub$Ϳ, reason: contains not printable characters */
        public static class C0068 implements IAlixPay {

            /* renamed from: Ϳ, reason: contains not printable characters */
            public IBinder f216;

            public C0068(IBinder iBinder) {
                this.f216 = iBinder;
            }
            ...
            public String Pay(String str) throws RemoteException {
                ...
                try {
                    ...
                    this.f216.transact(1, parcelObtain, parcelObtain2, 0);
            ...
            public void deployFastConnect() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f216.transact(6, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
            ...
            public int getVersion() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f216.transact(8, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
            ...
            public boolean manager(String str) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    parcelObtain.writeString(str);
                    this.f216.transact(7, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
            ...
            public String pay02(String str, Map map) throws RemoteException {
                ...
                try {
                    ...
                    this.f216.transact(9, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    return parcelObtain2.readString();
                } finally {
                    parcelObtain2.recycle();
            ...
            public String prePay(String str) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    parcelObtain.writeString(str);
                    this.f216.transact(5, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    return parcelObtain2.readString();
                } finally {
                    parcelObtain2.recycle();
            ...
            public void r03(String str, String str2, Map map) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeMap(map);
                    this.f216.transact(10, parcelObtain, null, 1);
                } finally {
                    parcelObtain.recycle();
                }
            }
            ...
            public void registerCallback(IRemoteServiceCallback iRemoteServiceCallback) throws RemoteException {
                ...
                try {
                    ...
                    this.f216.transact(3, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
            ...
            public void registerCallback03(IRemoteServiceCallback iRemoteServiceCallback, String str, Map map) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeString(str);
                    parcelObtain.writeMap(map);
                    this.f216.transact(11, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
            ...
            public String test() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f216.transact(2, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    return parcelObtain2.readString();
                } finally {
                    parcelObtain2.recycle();
            ...
            public void unregisterCallback(IRemoteServiceCallback iRemoteServiceCallback) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    parcelObtain.writeStrongBinder(iRemoteServiceCallback != null ? iRemoteServiceCallback.asBinder() : null);
                    this.f216.transact(4, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
        ...
        public static IAlixPay asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IAlixPay)) ? new C0068(iBinder) : (IAlixPay) iInterfaceQueryLocalInterface;
        }
