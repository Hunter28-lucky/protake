...
public interface IRemoteServiceCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRemoteServiceCallback {
        ...
        /* renamed from: com.alipay.android.app.IRemoteServiceCallback$Stub$Ϳ, reason: contains not printable characters */
        public static class C0069 implements IRemoteServiceCallback {

            /* renamed from: Ϳ, reason: contains not printable characters */
            public IBinder f217;

            public C0069(IBinder iBinder) {
                this.f217 = iBinder;
            }
            ...
            public int getVersion() throws RemoteException {
                ...
                try {
                    ...
                    this.f217.transact(4, parcelObtain, parcelObtain2, 0);
            ...
            public boolean isHideLoadingScreen() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f217.transact(3, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
            ...
            public void payEnd(boolean z, String str) throws RemoteException {
                ...
                try {
                    ...
                    this.f217.transact(2, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
            ...
            public void r03(String str, String str2, Map map) throws RemoteException {
                ...
                try {
                    ...
                    this.f217.transact(5, parcelObtain, null, 1);
                } finally {
                    parcelObtain.recycle();
                }
            }
            ...
            public void startActivity(String str, String str2, int i, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f217.transact(1, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
        ...
        public static IRemoteServiceCallback asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IRemoteServiceCallback)) ? new C0069(iBinder) : (IRemoteServiceCallback) iInterfaceQueryLocalInterface;
        }
