...
public class BATTransportStreamImpl implements BATTransportStream {
    ...
    @Override // com.blink.academy.film.support.stream.ts.google.API.DVB.BATTransportStream
    ...
    public String toXMLString(int i) {
        String str = new String() + MyUTIL.whiteSpaceStr(i) + "<BATTransportStream>\n";
        ...
        return str2 + MyUTIL.whiteSpaceStr(i) + "</BATTransportStream>\n";
    }
}
