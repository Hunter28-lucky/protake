...
public class TVCT {
    ...
    public int get(IBitstream iBitstream) throws IOException {
        int i;
        Util.trace(iBitstream.getpos(), 0, 0, "begin TVCT");
        ...
        this.f17638cn = 0;
        while (this.f17638cn < this.num_channels_in_section) {
            Util.trace(iBitstream.getpos(), 0, 0, "processing TVCTChannel channel");
            TVCTChannel tVCTChannel = new TVCTChannel();
            this.channel = tVCTChannel;
            i += tVCTChannel.get(iBitstream);
            this.f17638cn++;
        }
        ...
        Util.trace(iBitstream.getpos(), 0, 0, "end TVCT");
        return i;
    }

    public int put(IBitstream iBitstream) throws IOException {
        this.table_id = 200;
        iBitstream.putbits(200, 8);
