...
public class CVCTChannel {
    ...
    public int out_of_band;
    public int path_select;
    ...
    public int get(IBitstream iBitstream) throws IOException {
        int i;
        Util.trace(iBitstream.getpos(), 0, 0, "begin CVCTChannel");
        ...
        this.path_select = iBitstream.getbits(1);
        Util.trace(iBitstream.getpos() - 1, 1, this.path_select, "path_select (" + this.path_select + ")");
        this.out_of_band = iBitstream.getbits(1);
        Util.trace(iBitstream.getpos() - 1, 1, this.out_of_band, "out_of_band (" + this.out_of_band + ")");
        ...
        Util.trace(iBitstream.getpos(), 0, 0, "end CVCTChannel");
        return i;
    }
    ...
    public int put(IBitstream iBitstream) throws IOException {
        ...
        iBitstream.putbits(this.path_select, 1);
        iBitstream.putbits(this.out_of_band, 1);
    ...
    public int putxml(IBitstream iBitstream, boolean z) throws IOException {
        ...
        this.path_select = iBitstream.getbits(1);
        if (z) {
            XML.WriteXmlElement("<path_select type=\"flUInt\" bitLen=\"1\">" + this.path_select + "</path_select>");
        } else {
            XML.WriteXmlElement("<path_select bitLen=\"1\">" + this.path_select + "</path_select>");
        }
        this.out_of_band = iBitstream.getbits(1);
        if (z) {
            XML.WriteXmlElement("<out_of_band type=\"flUInt\" bitLen=\"1\">" + this.out_of_band + "</out_of_band>");
        } else {
            XML.WriteXmlElement("<out_of_band bitLen=\"1\">" + this.out_of_band + "</out_of_band>");
        }
        this.hide_guide = iBitstream.getbits(1);
        if (z) {
