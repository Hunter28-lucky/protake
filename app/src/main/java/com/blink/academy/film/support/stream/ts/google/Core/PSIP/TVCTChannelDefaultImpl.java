...
public class TVCTChannelDefaultImpl implements TVCTChannel {
    ...
    @Override // com.blink.academy.film.support.stream.ts.google.API.PSIP.TVCTChannel
    ...
    public void setShortName(char[] cArr) {
        this.short_name = new String(cArr).toCharArray();
    }
    ...
    public String toXMLString(int i) {
        String str = new String() + MyUTIL.whiteSpaceStr(i) + "<TVCTChannel>\n";
        ...
        return str2 + MyUTIL.whiteSpaceStr(i) + "</TVCTChannel>\n";
    }
}
