...
public class a implements IEventProcessor {
    ...
    private HashMap<String, ArrayList<com.xiaomi.clientreport.data.a>> f5485a;
    ...
    public void b() throws Throwable {
        HashMap<String, ArrayList<com.xiaomi.clientreport.data.a>> map = this.f5485a;
        if (map == null) {
            return;
        }
        if (map.size() > 0) {
            Iterator<String> it = this.f5485a.keySet().iterator();
            while (it.hasNext()) {
                ArrayList<com.xiaomi.clientreport.data.a> arrayList = this.f5485a.get(it.next());
    ...
    public String bytesToString(byte[] bArr) {
        ...
        if (bArr != null && bArr.length >= 1) {
            if (!com.xiaomi.clientreport.manager.a.a(this.a).m5122a().isEventEncrypted()) {
                return bc.b(bArr);
            }
            String strA = bm.a(this.a);
            if (!TextUtils.isEmpty(strA) && (bArrA = bm.a(strA)) != null && bArrA.length > 0) {
                try {
                    return bc.b(Base64.decode(h.a(bArrA, bArr), 2));
    ...
    public byte[] stringToBytes(String str) {
        ...
        if (!com.xiaomi.clientreport.manager.a.a(this.a).m5122a().isEventEncrypted()) {
            return bc.m5243a(str);
        }
        String strA = bm.a(this.a);
        byte[] bArrM5243a = bc.m5243a(str);
        if (!TextUtils.isEmpty(strA) && bArrM5243a != null && bArrM5243a.length > 1 && (bArrA = bm.a(strA)) != null) {
            try {
                if (bArrA.length > 1) {
                    return h.b(bArrA, Base64.encode(bArrM5243a, 2));
                }
            } catch (Exception e2) {
                com.xiaomi.channel.commonutils.logger.b.a(e2);
            }
    ...
    */
    private java.util.List<java.lang.String> a(java.lang.String r9) throws java.lang.Throwable {
        ...
        L1d:
            ...
            goto L6e
        L25:
            int r9 = com.xiaomi.push.z.a(r2)     // Catch: java.lang.Throwable -> L72 java.lang.Exception -> L75
        ...
        L39:
            ...
            goto L6e
        L41:
            int r9 = com.xiaomi.push.z.a(r3)     // Catch: java.lang.Throwable -> L72 java.lang.Exception -> L75
            r4 = 1
            if (r9 < r4) goto L69
    ...
    public void m5126a(com.xiaomi.clientreport.data.a[] aVarArr) throws Throwable {
        if (aVarArr == null || aVarArr.length == 0 || aVarArr[0] == null) {
            com.xiaomi.channel.commonutils.logger.b.m5113a("event data write to cache file failed because data null");
            return;
        }
        do {
            aVarArr = a(aVarArr);
                ...
                for (com.xiaomi.clientreport.data.a aVar : aVarArr) {
                    if (aVar != null) {
                        ...
                        if (bArrStringToBytes != null && bArrStringToBytes.length >= 1 && bArrStringToBytes.length <= 4096) {
                            ...
                            bufferedOutputStream.write(z.a(bArrStringToBytes.length));
