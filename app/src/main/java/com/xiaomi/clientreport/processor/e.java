...
public class e {
    public static void a(String str, com.xiaomi.clientreport.data.a[] aVarArr) throws IOException {
        ...
        try {
            ...
            try {
                ...
                HashMap<String, String> mapM5127a = m5127a(str);
    ...
    */
    ...
    public static long[] m5128a(String str) {
    ...
    /* renamed from: a, reason: collision with other method in class */
    private static HashMap<String, String> m5127a(String str) throws Throwable {
    ...
    /* JADX WARN: Removed duplicated region for block: B:67:0x00d7 A[PHI: r1
      0x00d7: PHI (r1v6 java.io.File) = (r1v5 java.io.File), (r1v7 java.io.File) binds: [B:66:0x00d5, B:32:0x0094] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* renamed from: a, reason: collision with other method in class */
    private static String[] m5129a(String str) {
    ...
    private static PerfClientReport a(String str) {
        ...
        try {
            String[] strArrM5129a = m5129a(str);
            if (strArrM5129a == null || strArrM5129a.length < 4 || TextUtils.isEmpty(strArrM5129a[0]) || TextUtils.isEmpty(strArrM5129a[1]) || TextUtils.isEmpty(strArrM5129a[2]) || TextUtils.isEmpty(strArrM5129a[3])) {
                return null;
            }
            blankInstance = PerfClientReport.getBlankInstance();
            blankInstance.production = Integer.parseInt(strArrM5129a[0]);
            blankInstance.clientInterfaceId = strArrM5129a[1];
            blankInstance.reportType = Integer.parseInt(strArrM5129a[2]);
            blankInstance.code = Integer.parseInt(strArrM5129a[3]);
    ...
    private static PerfClientReport a(PerfClientReport perfClientReport, String str) {
        long[] jArrM5128a;
        if (perfClientReport == null || (jArrM5128a = m5128a(str)) == null) {
            return null;
        }
        perfClientReport.perfCounts = jArrM5128a[0];
        perfClientReport.perfLatencies = jArrM5128a[1];
