...
public abstract class an {
    ...
    public static String f17901e = "com.xiaomi.push.SEND_MESSAGE";
    ...
    public static String q = "com.xiaomi.push.CHANGE_HOST";
    public static String r = "com.xiaomi.push.PING_TIMER";
    public static String s = "com.xiaomi.push.APP_CHANNEL_SWITCH";
    public static String t = "ext_user_id";
    public static String u = "ext_user_server";
    public static String v = "ext_user_res";
    public static String w = "ext_chid";
    public static String x = "ext_receive_time";
    public static String y = "ext_broadcast_time";
    public static String z = "ext_sid";
