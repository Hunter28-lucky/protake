...
public class fo extends fp {
    ...
    public boolean equals(Object obj) {
        ...
        String str = this.f;
        if (str == null ? foVar.f != null : !str.equals(foVar.f)) {
            return false;
        }
        String str2 = this.d;
        if (str2 == null ? foVar.d != null : !str2.equals(foVar.d)) {
            return false;
        }
        String str3 = this.f17864e;
        if (str3 == null ? foVar.f17864e != null : !str3.equals(foVar.f17864e)) {
            return false;
        }
        String str4 = this.c;
        if (str4 == null ? foVar.c == null : str4.equals(foVar.c)) {
            return this.b == foVar.b;
        }
        return false;
    }
    ...
    public fo(Bundle bundle) {
        ...
        this.f17864e = bundle.getString("ext_msg_sub");
        ...
        this.f5932b = bundle.getBoolean("ext_msg_encrypt", false);
    ...
    public String mo5496a() {
        ...
        if (com.umeng.analytics.pro.d.O.equalsIgnoreCase(this.b) && (ftVarM5497a = m5497a()) != null) {
