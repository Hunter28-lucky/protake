...
public abstract class cj {
    ...
    public static class a extends ci {
        ...
        public String a(Context context, String str, List<au> list) {
            ...
            return av.a(context, new URL(builderBuildUpon.toString()));
        }
    }
    ...
    */
    public static java.lang.String a(android.content.Context r20, java.lang.String r21, java.util.List<com.xiaomi.push.au> r22, com.xiaomi.push.ci r23, boolean r24) throws java.lang.NumberFormatException {
        /*
            r1 = r20
            r0 = r21
            r2 = r22
            r3 = r23
            boolean r4 = com.xiaomi.push.av.m5216a(r20)
            r5 = 0
            if (r4 == 0) goto Lc7
            ...
            if (r24 == 0) goto L26
            com.xiaomi.push.ch r6 = com.xiaomi.push.ch.a()     // Catch: java.net.MalformedURLException -> Lc3
            com.xiaomi.push.cd r6 = r6.m5294a(r0)     // Catch: java.net.MalformedURLException -> Lc3
            if (r6 == 0) goto L24
        ...
        L4c:
            ...
            boolean r0 = r3.m5304a(r1, r14, r15)     // Catch: java.io.IOException -> La4
            if (r0 != 0) goto L58
            goto Lc2
        L58:
    ...
    public static int a(List<au> list) {
        ...
        for (au auVar : list) {
            if (!TextUtils.isEmpty(auVar.a())) {
                length += auVar.a().length();
            }
            if (!TextUtils.isEmpty(auVar.b())) {
                length += auVar.b().length();
            }
        }
        return length * 2;
    }
