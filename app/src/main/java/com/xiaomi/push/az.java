...
public class az {
    ...
    private static byte[] f5610a;
    private static final String a = System.getProperty("line.separator");

    /* renamed from: a, reason: collision with other field name */
    private static char[] f5611a = new char[64];
    ...
    static {
        ...
        char[] cArr = f5611a;
        cArr[i] = PhoneNumberUtil.PLUS_SIGN;
        cArr[i + 1] = '/';
        f5610a = new byte[128];
        int i2 = 0;
        while (true) {
    ...
    public static char[] a(byte[] bArr, int i, int i2) {
        ...
        while (i < i7) {
            ...
            if (i3 < i7) {
                i5 = bArr[i3] & ExifInterface.MARKER;
                i3++;
            } else {
                i5 = 0;
            }
    ...
    public static byte[] m5226a(String str) {
            ...
            while (i < i6) {
                ...
                if (c3 <= 127 && c4 <= 127 && c <= 127 && c2 <= 127) {
                    ...
                    if (b >= 0 && b2 >= 0 && b3 >= 0 && b4 >= 0) {
                        int i11 = (b << 2) | (b2 >>> 4);
                        int i12 = ((b2 & com.umeng.analytics.pro.cb.m) << 4) | (b3 >>> 2);
                        int i13 = ((b3 & 3) << 6) | b4;
                        int i14 = i7 + 1;
                        bArr[i7] = (byte) i11;
                        if (i14 < i5) {
