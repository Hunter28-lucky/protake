...
public class PushMessageHelper {
    ...
    public static MiPushMessage generateMessage(hj hjVar, gt gtVar, boolean z) {
        MiPushMessage miPushMessage = new MiPushMessage();
        miPushMessage.setMessageId(hjVar.m5632a());
