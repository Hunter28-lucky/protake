...
/* compiled from: ActivityHome2BindingImpl.java */
/* renamed from: ࡠ, reason: contains not printable characters */
/* loaded from: classes.dex */
public class C3953 extends AbstractC3875 {

    /* renamed from: ފ, reason: contains not printable characters */
    @Nullable
    public static final ViewDataBinding.IncludedLayouts f13653 = null;

    /* renamed from: ދ, reason: contains not printable characters */
    @Nullable
    public static final SparseIntArray f13654;
    ...
    public C3953(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 19, f13653, f13654));
    }
    ...
    public C3953(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (SettingHintDialog) objArr[15], (View) objArr[4], (CardView) objArr[1], (View) objArr[18], (SettingHintDialog) objArr[13], (SettingHintDialog) objArr[11], (FrameLayout) objArr[5], (SettingHintDialog) objArr[9], (CameraView) objArr[3], (StyleHintView) objArr[6], (SettingHintDialog) objArr[16], (SettingHintDialog) objArr[14], (ScoreDialog) objArr[17], (ModeHintDialog) objArr[8], (SettingHintDialog) objArr[10], (ConstraintLayout) objArr[2], (ConstraintLayout) objArr[0], (SettingHintDialog) objArr[12], (SubscribeDialog) objArr[7]);
        this.f13655 = -1L;
        this.f13334.setTag(null);
        setRootTag(view);
        invalidateAll();
    }
}
