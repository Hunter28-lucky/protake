...
final class Utils {
    ...
    public static AbstractC4809 buffer(AbstractC4809 abstractC4809) throws IOException {
        Buffer buffer = new Buffer();
        abstractC4809.source().readAll(buffer);
        return AbstractC4809.create(abstractC4809.contentType(), abstractC4809.contentLength(), buffer);
    }
